...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your QUANTUS AI verification code</Preview>
    <Body style={main}>
...
const codeStyle = { fontFamily: "'Space Grotesk', Courier, monospace", fontSize: '28px', fontWeight: 'bold' as const, color: '#b8942e', letterSpacing: '0.15em', margin: '0 0 30px' }
