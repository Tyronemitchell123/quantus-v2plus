...
const codeSection = { textAlign: 'center' as const, margin: '24px 0 32px', backgroundColor: '#f8f6f1', borderRadius: '8px', padding: '20px' }
const codeStyle = { fontFamily: "'Courier New', Courier, monospace", fontSize: '32px', fontWeight: '700' as const, color: '#C4993A', letterSpacing: '0.2em', margin: '0' }
