...
const Chat = () => {
  ...
  const [largeText, setLargeText] = useState(() => localStorage.getItem("quantus-large-text") === "true");
      ...
      <div className="flex-1 flex relative z-[2]">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="border-b border-border/50 glass px-6 py-4 flex items-center gap-4">
            ...
            {/* Font size toggle */}
            <button
              onClick={() => setLargeText((v) => { const next = !v; localStorage.setItem("quantus-large-text", String(next)); return next; })}
