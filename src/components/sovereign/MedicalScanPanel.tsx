...
import {
  Stethoscope, Search, AlertTriangle, Terminal, Loader2, CheckCircle, XCircle,
} from "lucide-react";
      ...
      <div className="glass-card p-4">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="flex-1 bg-background/50 border border-border/50 rounded-lg px-3 py-2 text-xs font-body text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/50"
          />
          <Button
            onClick={startScan}
            disabled={isScanning}
        ...
        <p className="font-body text-[9px] text-muted-foreground mt-2">
          Scans practice management portals for ghosted appointments. Filters: IMPLANT, SURGERY, INVISALIGN, LASIK.
        </p>
      </div>
