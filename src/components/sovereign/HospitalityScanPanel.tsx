...
import {
  ...
  ArrowLeftRight, Tag, Gift, TrendingDown,
} from "lucide-react";
              ...
              {liveLogs.map((log, i) => (
                <motion.div
                  ...
                  className={
                    ...
                    : log.includes("[RECOVERY]") || log.includes("[COMMISSION]") ? "text-primary"
              ...
              <div className="grid grid-cols-3 gap-4 items-center">
                ...
                <div className="text-center">
                  ...
                  <p className="font-body text-[9px] text-muted-foreground mt-1">
                    {result.parity.direct_available}
                  </p>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-body text-[10px] tracking-[0.2em] uppercase text-amber-400">
                    Leakage Recovery — AI-Generated Direct-Only Promo
                  </span>
                </div>
